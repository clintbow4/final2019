...
trialtbl=xtabs(~infected+LBGT,data=avast)
...
I'm going to use a barchart, chi-square test, and fisher's exact test to see how well the drug worked for the LBGT communtity.
...
Based on the chi-squared test and the fisher's exact test the odds of getting aids is lower if you take the drug.
